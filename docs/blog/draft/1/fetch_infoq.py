...
def fetch_and_save(url, output_dir):
    ...
    # infoq 文章主体通常在 .article-content 或 .main-content 中
    article = soup.find(class_='article-content') or soup.find(class_='main-content') or soup.find('article') or soup.find('main') or soup.find('body')
    ...
    for idx, img in enumerate(images):
        ...
        filename = f"image_infoq_{idx:03d}{ext}"
...
if __name__ == '__main__':
    url = 'https://xie.infoq.cn/article/a6f4f9a80454de444302e8120'
