...
def process_md(md_file, output_dir):
    ...
    output_file = os.path.join(output_dir, '什么是KMP算法（详解）.md')
...
if __name__ == '__main__':
    md_file = r'd:\Program\magic-resume\temp_infoq.md'
    output_dir = r'd:\Program\magic-resume'
    process_md(md_file, output_dir)
